    ...
    return (
        <div className="container mx-auto px-4 py-8">
                ...
                <tbody>
                    {sortedPackingList.map((packingItem) => (
                        <tr key={packingItem.id}>
                            <td className="border px-4 py-2">{packingItem.item}</td>
                            <td className="border px-4 py-2">{packingItem.quantity}</td>
                            <td className="border px-4 py-2">{packingItem.category}</td>
                            <td className="border px-4 py-2">{packingItem.priority}</td>
                            <td className="border px-4 py-2">
                                <UpdateCheckbox packingListId={packingItem.id} />
                            </td>
                            <td className="border px-4 py-2">{packingItem.notes}</td>
                            <td className="border px-4 py-2">{packingItem.deadline}</td>
                            <td className="border px-4 py-2">
                                ...
                                <Link to={`/api/packing_list/${packingItem.id}`}>
            ...
            <Link to="/api/packing_list/create/" className="block mt-4">
                <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Create Packing List</button>
            </Link>
        </div>
    );
}
